...
from core.indicators import add_all_indicators, get_indicator_summary, generate_trading_signals
...
def tool_fetch_stock_data(symbol: str, start_date: str, end_date: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        result = {
            ...
            "analysis": {
                ...
                "ma_5": round(indicator_summary['ma_5'], 2) if indicator_summary['ma_5'] else None,
                "ma_20": round(indicator_summary['ma_20'], 2) if indicator_summary['ma_20'] else None,
                "ma_60": round(indicator_summary['ma_60'], 2) if indicator_summary['ma_60'] else None,
                "rsi_14": round(indicator_summary['rsi_14'], 2) if indicator_summary['rsi_14'] else None,
                "macd": round(indicator_summary['macd'], 4) if indicator_summary['macd'] else None,
                "macd_signal": round(indicator_summary['macd_signal'], 4) if indicator_summary['macd_signal'] else None,
            },
            "signals": {
