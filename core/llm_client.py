...
qwen_client = (
    OpenAI(api_key=qwen_api_key, base_url=qwen_base_url) if qwen_api_key else None
)
zhipu_client = (
    OpenAI(api_key=zhipu_api_key, base_url=zhipu_base_url) if zhipu_api_key else None
)
deepseek_client = (
...
kimi_client = (
    OpenAI(api_key=moonshot_api_key, base_url=moonshot_base_url)
    if moonshot_api_key
    else None
)
